...
export default function Profile() {
  ...
  return (
    <>
      <ProfileHeroSection />
      <section className="bg-surface-container/50 shadow-primary/25 px-margin-mobile p-gutter mx-auto my-32 flex min-h-[35vh] min-w-4xl flex-col gap-6 rounded-2xl shadow-md">
